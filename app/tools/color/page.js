  ...
  const handleConvert = useCallback(() => {
    ...
    try {
      ...
      if (hexRegex.test(trimmed)) {
        ...
        setError('Invalid color format. Use Hex, RGB, or HSL.');
        setResults(null); return;
      }
      if ([r, g, b].some(v => v < 0 || v > 255)) {
        setError('Values out of range (0-255).'); setResults(null); return;
      }
      const hsl = rgbToHsl(r, g, b);
      setResults({ hex: rgbToHex(r, g, b), rgb: `rgb(${r}, ${g}, ${b})`, hsl: `hsl(${hsl.h}, ${hsl.s}%, ${hsl.l}%)`, r, g, b });
        ...
        <GlassCard>
          <div className="p-4">
            ...
            <div className="flex gap-2">
              <input value={input} onChange={(e) => setInput(e.target.value)} placeholder="#ff0066 or rgb(255,0,102) or hsl(336,100%,50%)"
