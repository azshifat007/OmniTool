      ...
      <head>
        ...
        <style>
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          li { margin: 2pt 0; }
          code { background: #f0f0f0; padding: 1pt 4pt; border-radius: 3pt; font-size: 10pt; font-family: monospace; }
          pre { background: #f5f5f5; padding: 10pt; border-radius: 4pt; overflow-x: auto; font-size: 10pt; font-family: monospace; margin: 8pt 0; white-space: pre-wrap; }
  ...
  return (
    <div>
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        <h1 className="font-heading text-3xl font-bold text-text mb-2">Markdown to PDF</h1>
        <p className="text-text-secondary">Write Markdown and export as a styled PDF</p>
      </motion.div>
